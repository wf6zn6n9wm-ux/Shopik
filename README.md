...
# Urok+ — кабінет репетитора (папка `urok/`)

**Самостійний застосунок** для репетиторів, викладачів і тренерів: розклад
занять, картки учнів, гроші й маркет матеріалів. Живе в папці `urok/`,
відкривається за `/urok/`, з рештою репозиторію не пов'язаний.
