...
и у всех одинаковые. Сложность идёт двумя участками: **первые девять уровней —
разминка** на велосипеде, пропастей там нет вовсе; **с десятого сложность
скачком вырастает** и дальше растёт до предела к пятидесятому. Чем выше
уровень, тем чаще выпадают тяжёлые секции: на первых трассах это холмы и
столики, на последних — пропасти, гребёнка и уступы. Крутизна волн ограничена
так, чтобы склон нигде не превращался в стену (максимум 56°), а ширина ям —
так, чтобы яму перепрыгивал транспорт, доступный на этом уровне.
