...
Сложность — **в маршруте, а не в наказании**. Физика прощает: байк не
складывается от неточного приземления, не опрокидывается сам от газа, гашение
вращения выравнивает его после прыжка. Останавливают игрока препятствия —
пропасти, которые надо перепрыгнуть, узкие щели, отвесные стенки, уступы и
затяжные подъёмы, где нужен разгон.

Управление при этом остаётся нужным: газ задирает нос, тормоз опускает,
наклон работает в полную силу в воздухе и вдвое слабее на земле (землёй байк
не перевернуть, но перенести баланс на подъёме можно). Сам наклон нарастает за
доли секунды — короткое касание даёт лёгкую поправку, удержание полный момент.

Бот, который **только держит газ**, проходит 5 уровней из 50 — и все пять в
первом десятке; дальше его останавливает уже сам рельеф.
