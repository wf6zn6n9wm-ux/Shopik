...
/* ─── скільки серверних функцій ───
   На безкоштовному тарифі Vercel бере не більше дванадцяти на одну
   ...
   Акаунт відтоді перейшов на Pro саме заради цього ліміту (та ще й
   заради інших застосунків на тому самому акаунті) — стелю підняли, а
   не прибрали: запас на майбутнє, а не запрошення розкидати файли, де
   заманеться.
