...
В Data safety добавьте: «Email передаётся платёжному
сервису для привязки подписки» — подписка оформляется на сайте, и логин
нужен, чтобы связать оплату с аккаунтом.
