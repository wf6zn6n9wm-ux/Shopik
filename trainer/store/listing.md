...
- **Клиенты, тренировки, оплаты и заметки** лежат в хранилище приложения на
  устройстве. На сервер уходит их зашифрованная копия: ключ выводится из
  пароля кабинета и на сервер не попадает, прочитать содержимое мы не можем.
  Копию можно выключить в настройках. В анкетах это «данные, связанные с
  пользователем, не используемые для отслеживания».
